...
// interruption
if (mtime >= mtimecmp && mie_i[7] == 1'b1 && mode != `MODE_M && stall != 6'b111111) begin
    direct_we = 1;
...
// page fault happens at MEM phase
else if (mem_page_fault_load) begin
    direct_we = 1;
    mstatus_o = {mstatus_i[31:13], mode, mstatus_i[10:0]};
    mie_o = mie_i;
    mtvec_o = mtvec_i;
...
else if (mem_page_fault_store) begin
    direct_we = 1;
    mstatus_o = {mstatus_i[31:13], mode, mstatus_i[10:0]};
    mie_o = mie_i;
    mtvec_o = mtvec_i;
...
else if (if_page_fault_if) begin
    direct_we = 1;
    mstatus_o = {mstatus_i[31:13], mode, mstatus_i[10:0]};
    mie_o = mie_i;
    mtvec_o = mtvec_i;
...
else if ((satp_i[31] == 1'b0 || mode != `MODE_U) && mem_load_access == 1) begin
    direct_we = 1;
    mstatus_o = {mstatus_i[31:13], mode, mstatus_i[10:0]};
    mie_o = mie_i;
    mtvec_o = mtvec_i;
...
else if ((satp_i[31] == 1'b0 || mode != `MODE_U) && mem_store_access == 1) begin
    direct_we = 1;
    mstatus_o = {mstatus_i[31:13], mode, mstatus_i[10:0]};
    mie_o = mie_i;
    mtvec_o = mtvec_i;
