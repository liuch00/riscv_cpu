...
<<<<<<< HEAD
parameter BASE_RAM_INIT_FILE = "D:\\Temp\\exp_mem.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�?
=======
parameter BASE_RAM_INIT_FILE = "D:\\Temp\\kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�?
>>>>>>> dev-prediction
...
//parameter BASE_RAM_INIT_FILE = "C:\\Users\\wwh\\Desktop\\2\\vga.bin";
